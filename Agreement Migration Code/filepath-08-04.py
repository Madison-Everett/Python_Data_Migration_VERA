...
wb = xlsxwriter.Workbook('/Users/everetmm/Desktop/Agreement_Documentspt.8.xlsx')
...
root_dir = "/Users/everetmm/Desktop/Agreement_Migration_pt6"
...
for dir_, _,files in os.walk(root_dir):
     for file_name in files:
               if "(Original)" in file_name:
                   ...
                   ws.write(row, RelativeFilePathcolumn, "Agreement_Migration_pt6/"+rel_file)

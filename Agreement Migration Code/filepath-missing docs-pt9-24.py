...
wb = xlsxwriter.Workbook('/Users/everetmm/Desktop/Agreement_Documentspt.10.xlsx')
...
root_dir = "/Users/everetmm/Desktop/Agreement_Migration_pt10"
...
for dir_, _,files in os.walk(root_dir):
     for file_name in files:
               if "(Original)" in file_name:
                   ...
                   ws.write(row, RelativeFilePathcolumn, "Agreement_Migration_pt10/"+rel_file)

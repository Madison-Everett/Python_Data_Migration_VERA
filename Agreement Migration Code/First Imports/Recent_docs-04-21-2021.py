...
for x in filesid:
    ...
    try:
        ...
        try:
              os.mkdir("/Users/everetmm/Desktop/New/Contract_"+filesid[x][0:5])
              print("Directory " , filesid[x][0:5] ," Created ")
              open("/Users/everetmm/Desktop/New/Contract_"+filesid[x][0:5]+"/Contract "+ filesid[x]+".pdf", 'wb').write(file)

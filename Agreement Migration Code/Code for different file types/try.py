...
for x in troublesome:
    ...
    if x == 158828 or x==159296 or x== 186958: 
        try:
          ...
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".docx", 'wb').write(file)
        ...
        try:
          os.mkdir("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5])
          print("Directory " , troublesome[x][0:5] ," Created ")
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".xlsx", 'wb').write(file)
        except FileExistsError:
          print("Directory " , troublesome[x][0:5],  " already exists")
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".xlsx", 'wb').write(file)         
    elif x == 192730:
        try:
          os.mkdir("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5])
          print("Directory " , troublesome[x][0:5] ," Created ")
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".jpg", 'wb').write(file)
        except FileExistsError:
          print("Directory " , troublesome[x][0:5],  " already exists")
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".jpg", 'wb').write(file)
        ...
        try:
          os.mkdir("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5])
          print("Directory " , troublesome[x][0:5] ," Created ")
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".txt", 'wb').write(file)
        except FileExistsError:
          print("Directory " , troublesome[x][0:5],  " already exists")
          open("/Users/everetmm/Desktop/Contracts/Contract_"+troublesome[x][0:5]+"/Contract "+ troublesome[x]+"ID:"+str(x)+".txt", 'wb').write(file)
